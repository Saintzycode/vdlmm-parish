<template>
  <section id="location" class="bg-white py-16 md:py-24 px-4">
...
const locationInfo = [
  ...
  },
  {
    icon: '🏛️',
    label: 'Parish Office',
    value: 'Tuesday–Saturday: 8:00 AM – 5:00 PM<br>Sunday: 8:00 AM – 12:00 PM<br><span class="text-red-600 font-semibold">Monday: Closed</span>'
  },
  {
    icon: '⛪',
    label: 'Chapels',
...
function openMap() {
  window.open(
    'https://maps.google.com/?q=Virgen+de+la+Medalla+Milagrosa+Parish+Mangaldan+Pangasinan',
    '_blank'
  )
}
</script>